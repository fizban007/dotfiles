...
function displayMonth(month,year,weekStart)
        ...
        lines = lines .. "<span color='cyan'>"
        for x=0,6 do
                lines = lines .. os.date("%a ",os.time{year=2006,month=1,day=x+wkSt})
        end
        lines = lines .. "</span>"

        lines = lines .. "\n" .. "<span color='orange'>" .. os.date(" %V",os.time{year=year,month=month,day=1}) .. "</span>"
        ...
        for d=1,mthDays do
                ...
                if writeLine == 8 then
                        writeLine = 1
                        lines = lines .. "\n" .. "<span color='orange'>" .. os.date(" %V",t) .. "</span>"
                end
        ...
        local header = "<b><span color='lightblue'>" .. os.date("%B %Y\n",os.time{year=year,month=month,day=1}) .. "</span></b>"
